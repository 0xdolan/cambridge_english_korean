# Cambridge English Korean Dictionary - Online

Cambridge English Korean Dictionary (usable Online) for GoldenDict
...
- for **Name** section, copy and paste the _exact name_ of the ".py" file name. e.g.: "Cambridge_English_Korean.py"
